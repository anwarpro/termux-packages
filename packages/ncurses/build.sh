...
TERMUX_PKG_SHA256=(aa057eeeb4a14d470101eff4597d5833dcef5965331be3528c08d99cebaa0d17
...
TERMUX_PKG_SRCURL=(https://ftp.gnu.org/gnu/ncurses/ncurses-${TERMUX_PKG_VERSION[0]}.tar.gz
		   https://ftp.osuosl.org/pub/blfs/conglomeration/rxvt-unicode/rxvt-unicode-${TERMUX_PKG_VERSION[1]}.tar.bz2
